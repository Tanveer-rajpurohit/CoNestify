...
export const useGetPeopleList = () => {
  ...
  const WorkspacePeopleList = async (workspaceId: string) => {
    setLoading(true);
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        console.error(
          "An unknown error occurred while fetching workspace people list:",
          err
        );
  ...
  return { WorkspacePeopleList, loading,setLoading };
};
